...
public class Experiment {
  ...
  //stem variable will be used to do the pseudo relevance feedback
  ...
  public Experiment(File corpusDir, File queryFile, File outFile, short docType, boolean stem
      ...
      throws IOException {
    this.corpusDir = corpusDir;
    this.index = new InvertedIndex(corpusDir, docType, stem, false, pseudofeedback, top_k, alpha, beta, gamma);
    this.queryFile = queryFile;
    this.outFile = outFile;
    this.stem = stem;
  ...
  boolean processQuery(BufferedReader in) throws IOException {
    ...
    // correctRetrievals : documents that are truely relevant to query
